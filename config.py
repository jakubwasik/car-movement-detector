...
FEATURES = ['mean_x', 'mean_z', 'std_z', 'speed_mean', 'energy_x', 'signChange',  'coeff_x', 'freq_z',
            'var_x', 'var_z', 'max_z', 'min_x', 'skew', 'fft_peaks_x', 'psd_peaks_x', 'autocorr_peaks_z',
            'fft_peaks_z', 'psd_peaks_z', 'std_dx', 'energy_dx', 'kurtosis', 'percentile_z_25']
FREQ = 12
WINDOW_SIZE = 5.0
