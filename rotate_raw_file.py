...
file = os.path.join(DATA_FILE, "raw_data_2018-06-10-15-00-58.csv")
ref_file = os.path.join(REF_DATA_FILE, "wartosc_referencyjna_2018-06-10-15-00-04_2018-06-10_15_00_59.csv")
